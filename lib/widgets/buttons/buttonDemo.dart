      ...
      body: Container(
        ...
        child: GridView.count(
          ...
          children: <Widget>[
            ...
            WidgetCustomItem(popupMenuButtonDemoName, Icons.radio_button_checked),
            WidgetCustomItem(raisedButtonDemoName, Icons.radio_button_checked),
            WidgetCustomItem(rawMaterialButtonDemoName, Icons.radio_button_checked),
          ],
        ),
      ),
    );
